...
projects:
  ...
  - title: "Menu Profit Optimizer"
    category: "Menu Profitability · Engineering & Decision"
    description: "Kasavana–Smith classification plus a reprice/recost decision layer — see contribution, mix, and quadrant position move on the matrix."
    url: "/tools/menu-profit-optimizer.html"
  ...
  - title: "Channel Contribution Analyzer"
    category: "Revenue Management · Distribution Cost"
    description: "Model what shifting the booking-channel mix does to blended distribution cost and annual GOP at constant volume."
    url: "/tools/channel-contribution-analyzer.html"
  - title: "F&B Budget & Variance Model"
    category: "Operations & Budgeting · Budget vs Actual"
    description: "Bridge budgeted profit to actual through a variance waterfall splitting the gap into volume, rate, cost-input, and fixed drivers."
    url: "/tools/fb-budget-variance.html"  
---
